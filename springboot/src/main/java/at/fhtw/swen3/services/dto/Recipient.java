...
public class Recipient {
  ...
  */
  @NotNull 
  @Schema(name = "name", description = "Name of person or company.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "street", description = "Street", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "postalCode", description = "Postalcode", requiredMode = Schema.RequiredMode.REQUIRED)

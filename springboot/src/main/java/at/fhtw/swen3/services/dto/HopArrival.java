...
public class HopArrival {
  ...
  */
  ...
  @Schema(name = "code", description = "Unique CODE of the hop.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "description", description = "Description of the hop.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "dateTime", description = "The date/time the parcel arrived at the hop.", requiredMode = Schema.RequiredMode.REQUIRED)

...
public class GeoCoordinate {
  ...
  */
  @NotNull 
  @Schema(name = "lat", description = "Latitude of the coordinate.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "lon", description = "Longitude of the coordinate.", requiredMode = Schema.RequiredMode.REQUIRED)

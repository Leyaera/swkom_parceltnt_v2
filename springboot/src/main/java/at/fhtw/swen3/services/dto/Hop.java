...
public class Hop {
  ...
  */
  @NotNull 
  @Schema(name = "hopType", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "processingDelayMins", description = "Delay processing takes on the hop.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "locationName", description = "Name of the location (village, city, ..) of the hop.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "locationCoordinates", requiredMode = Schema.RequiredMode.REQUIRED)

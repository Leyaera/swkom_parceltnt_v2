...
public class TrackingInformation {
  ...
  */
  @NotNull 
  @Schema(name = "state", description = "State of the parcel.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "visitedHops", description = "Hops visited in the past.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "futureHops", description = "Hops coming up in the future - their times are estimations.", requiredMode = Schema.RequiredMode.REQUIRED)

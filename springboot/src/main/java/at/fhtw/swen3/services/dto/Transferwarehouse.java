...
public class Transferwarehouse extends Hop {
  ...
  */
  @NotNull 
  @Schema(name = "regionGeoJson", description = "GeoJSON (https://geojson.org/) of the area covered by the logistics partner.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "logisticsPartner", description = "Name of the logistics partner.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "logisticsPartnerUrl", description = "BaseURL of the logistics partner's REST service.", requiredMode = Schema.RequiredMode.REQUIRED)
